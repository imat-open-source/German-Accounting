frappe.ui.form.on(cur_frm.doctype, {
	validate: function (cur_frm) {
	    ...
	    {
	        if (cur_frm.doc.items[row].item_group == "Goods") {goods += cur_frm.doc.items[row].qty * cur_frm.doc.items[row].price_list_rate}
	        else if (cur_frm.doc.items[row].item_group == "Services") {services += cur_frm.doc.items[row].qty * cur_frm.doc.items[row].price_list_rate}   
	    }
